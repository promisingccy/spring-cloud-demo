-- 数据库
CREATE DATABASE IF NOT EXISTS imooc_homepage_sc DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户课程表';
